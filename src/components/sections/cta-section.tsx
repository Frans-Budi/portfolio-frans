...
export function CtaSection() {
  return (
    <section className="container-page py-16">
      <div className="grid overflow-hidden rounded-[2rem] border border-primary/20 bg-primary/10 md:grid-cols-[1.3fr_0.7fr]">
        <div className="p-8 sm:p-10 lg:p-12">
          ...
          <p className="mt-5 max-w-2xl text-muted-foreground">
            I can help with mobile-first product delivery, fintech workflows,
            Firebase-backed apps, and polished case-study-ready product execution.
          </p>
        </div>
        <div className="grid gap-3 border-t border-primary/20 p-8 sm:p-10 md:border-l md:border-t-0">
